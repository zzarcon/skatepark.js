...
function getPropNamesAndSymbols$1(obj = {}) {
  const listOfKeys = Object.getOwnPropertyNames(obj);
  return isFunction$1(Object.getOwnPropertySymbols) ? listOfKeys.concat(Object.getOwnPropertySymbols(obj)) : listOfKeys;
}
...
var index$4 = typeof self === 'object' && self.self === self && self || typeof commonjsGlobal === 'object' && commonjsGlobal.global === commonjsGlobal && commonjsGlobal || commonjsGlobal;
...
const nativeHints$1 = ['native code', '[object MutationObserverConstructor]' // for mobile safari iOS 9.0
];
var native$1 = (fn => nativeHints$1.map(hint => (fn || '').toString().indexOf([hint]) > -1).reduce((a, b) => a || b));
...
function createNativePropertyDescriptor$1(propDef) {
  ...
  prop.beforeDefineProperty = elem => {
    ...
    // Reflect to Target Attribute
    const mustReflect = propDef.attrTarget && !empty$1(initialValue) && (!valueFromAttrSource || propDef.attrTargetIsNotSource);
...
function preventDoubleCalling$1(elem, name$$1, oldValue, newValue) {
  return name$$1 === elem[_prevName$1] && oldValue === elem[_prevOldValue$1] && newValue === elem[_prevNewValue$1];
}
...
function getPropNamesAndSymbols$2(obj = {}) {
  const listOfKeys = Object.getOwnPropertyNames(obj);
  return isFunction$2(Object.getOwnPropertySymbols) ? listOfKeys.concat(Object.getOwnPropertySymbols(obj)) : listOfKeys;
}
...
var index$8 = typeof self === 'object' && self.self === self && self || typeof commonjsGlobal === 'object' && commonjsGlobal.global === commonjsGlobal && commonjsGlobal || commonjsGlobal;
...
function builder$2(...tags) {
  ...
  return tags.map(tag => (...args) => element$2.bind(null, tag, ...args));
}
...
const nativeHints$2 = ['native code', '[object MutationObserverConstructor]' // for mobile safari iOS 9.0
];
var native$2 = (fn => nativeHints$2.map(hint => (fn || '').toString().indexOf([hint]) > -1).reduce((a, b) => a || b));
...
function createNativePropertyDescriptor$2(propDef) {
  ...
  prop.beforeDefineProperty = elem => {
    ...
    // Reflect to Target Attribute
    const mustReflect = propDef.attrTarget && !empty$2(initialValue) && (!valueFromAttrSource || propDef.attrTargetIsNotSource);
...
function preventDoubleCalling$2(elem, name$$1, oldValue, newValue) {
  return name$$1 === elem[_prevName$2] && oldValue === elem[_prevOldValue$2] && newValue === elem[_prevNewValue$2];
}
...
class SKSpinner extends Component$2 {
  ...
  renderCallback() {
    ...
    h$2('style', mergedStyles), ...layout(this.type, overlay)];
  }
}
...
class SKEmoji extends Component {
  ...
  renderCallback() {
    ...
    return [h('style', stylesDefinition), h('sk-growy', {
      class: 'text',
  ...
  renderedCallback() {
    ...
    Object.keys(this.emojis).forEach(category => {
      this.intersectionObserver.observe(this.shadowRoot.querySelector(`[data-category="${ category }"]`));
    });
  }
